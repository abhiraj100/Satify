    ...
    <AppLayout>
      <div className="flex-1 flex flex-col items-center bg-blue-300 p-4 rounded-lg shadow-lg">
        ...
        <div className="flex items-center gap-4 flex-wrap justify-center">
          <div className="w-16 h-16 bg-yellow-400 text-center text-2xl rounded-full flex items-center justify-center font-bold">
            1
          </div>
          <div className="w-16 h-16 bg-gray-300 text-center text-2xl rounded-full flex items-center justify-center font-bold">
            2
          </div>
          <div className="w-16 h-16 bg-gray-300 text-center text-2xl rounded-full flex items-center justify-center font-bold">
            3
